...
return [
    ...
    'form' => [
        ...
        'edit_title' => 'Modifier le sondage',
        'fields' => [
            'title' => ['label' => 'Titre (optionnel)'],
            'question' => ['label' => 'Question *'],
            'options' => ['label' => 'Options (min. 2) *', 'placeholder' => 'Option :number'],
            'is_draft' => ['label' => 'Brouillon (ne pas lancer maintenant)'],
            'allow_multiple' => ['label' => 'Permettre plusieurs choix'],
            'results_public' => ['label' => 'Résultats publics'],
            'duration' => ['label' => 'Durée en secondes (optionnel)'],
        ],
        'actions' => [
            'create' => 'Créer',
            'save' => 'Enregistrer',
